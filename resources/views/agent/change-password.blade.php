...
@section('title', $forced ? 'Choose a new password' : 'Change password')
@section('heading', $forced ? 'Choose a new password' : 'Change password')
@section('subheading', $forced
    ? 'For security, set your own password before you start calling.'
...
@section('content')
    ...
    <form method="POST" action="{{ route('agent.password.change.update') }}" style="display:grid; gap:1.5rem;">
        @csrf
            ...
            <div data-field-wrapper class="fi-fo-field">
                <div class="fi-fo-field-label-col">
                    <div class="fi-fo-field-label-ctn">
                        <label for="current_password" class="fi-fo-field-label">
                            <span class="fi-fo-field-label-content">
                                Current password<sup class="fi-fo-field-label-required-mark">*</sup>
                            </span>
                        </label>
                    </div>
                </div>
            ...
            <div class="fi-fo-field-label-col">
                <div class="fi-fo-field-label-ctn">
                    <label for="password" class="fi-fo-field-label">
                        <span class="fi-fo-field-label-content">
                            New password<sup class="fi-fo-field-label-required-mark">*</sup>
                        </span>
                    </label>
                </div>
            </div>
            ...
            <div class="fi-fo-field-label-col">
                <div class="fi-fo-field-label-ctn">
                    <label for="password_confirmation" class="fi-fo-field-label">
                        <span class="fi-fo-field-label-content">
                            Confirm new password<sup class="fi-fo-field-label-required-mark">*</sup>
                        </span>
                    </label>
                </div>
            </div>
    ...
    <div style="text-align:center;">
        ...
        @else
            <x-filament::link :href="route('agent.workspace')">
                Back to workspace
            </x-filament::link>
        @endif
    </div>
