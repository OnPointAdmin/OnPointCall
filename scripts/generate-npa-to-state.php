...
$byState = [
    ...
    'AR' => ['327', '479', '501', '870'],
    'CA' => ['209', '213', '279', '310', '323', '341', '350', '357', '369', '408', '415', '424', '442', '510', '530', '559', '562', '619', '626', '628', '650', '657', '661', '669', '707', '714', '747', '760', '805', '818', '820', '831', '840', '858', '909', '916', '925', '949', '951'],
...
file_put_contents(__DIR__.'/../app/Support/data/npa_to_state.php', $output);

echo 'Wrote '.count($map).' NPAs'.PHP_EOL;
