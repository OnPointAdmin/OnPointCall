...
class LeadForm
{
    public static function configure(Schema $schema, bool $withHistory = false): Schema
    {
        $components = [
        ...
        if ($withHistory) {
            $components[] = Section::make('History')
                ->columnSpanFull()
                ->schema([
                    Html::make(function (Lead $record): HtmlString {
                        return new HtmlString(view('filament.leads.history-table', [
