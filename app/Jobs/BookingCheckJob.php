...
class BookingCheckJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(SalesforceBookingService $bookingService): void
    {
        ...
        try {
            $bookingService->checkLeads($leads, $this->actorId, $this->qualifyBatchId);
        } finally {
